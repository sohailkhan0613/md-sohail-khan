      ...
      <main className="pt-24 pb-16">
        ...
        <section className="py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-lg text-luxury-lightGray max-w-2xl mx-auto mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <a href="/resume.pdf" className="btn-outline inline-flex items-center" download>
        ...
        <section className="py-12 px-6">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="luxury-card flex flex-col justify-between h-full">
                <div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {testimonials.map((testimonial, index) => (
                <Card key={index} className="luxury-card hover:border-luxury-gold/50 transition-all group">
                  <CardHeader>
                ...
                <Tabs defaultValue="tech-stack" className="w-full">
                  ...
                  <TabsContent value="tech-stack" className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-luxury-navy/50 p-4 rounded-lg">
